...
{
    /// <summary>
    /// This class is the repository for fetching, adding, and removing instances of <see cref="Asp330TestLedCheck"/>
    ...
    /// </summary>
    public class Asp330TestLedCheckRepository : Repository<Asp330TestLedCheck, Guid>, IAsp330TestLedCheckRepository
    {
        public Asp330TestLedCheckRepository(TceContext context) : base(context)
        {
            Entities = Context.Asp330TestLedChecks;
        }
    }
}