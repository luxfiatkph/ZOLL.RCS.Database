...
{
    [TestClass]
    public class Asp330TestConditionalPmDueResetIntegrationTests : DataIntegrationSubItemTestBase<Asp330Test,
        Asp330TestConditionalPmDueReset, Guid, IAsp330TestRepository, IAsp330TestConditionalPmDueResetRepository>
    {
        ...
        {
            CrudTest(nameof(Asp330TestConditionalPmDueReset.Asp330TestId));
        }
