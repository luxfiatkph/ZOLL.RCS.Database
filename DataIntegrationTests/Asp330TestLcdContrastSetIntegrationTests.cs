...
{
    [TestClass]
    public class Asp330TestLcdContrastSetIntegrationTests : DataIntegrationSubItemTestBase<Asp330Test,
        Asp330TestLcdContrastSet, Guid, IAsp330TestRepository, IAsp330TestLcdContrastSetRepository>
    {
        public Asp330TestLcdContrastSetIntegrationTests()
        {
            ItemRepository = UnitOfWork.Asp330Tests;
            SubItemRepository = UnitOfWork.Asp330TestLcdContrastSets;
